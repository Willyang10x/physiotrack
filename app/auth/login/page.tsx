...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(error instanceof Error ? error.message : "Ocorreu um erro ao entrar.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      const { error } = await supabase.auth.signInWithOAuth({
        provider: "google",
        options: {
          // Redireciona para a rota de callback que processa o login
          ...
          <CardContent>
            ...
            <div className="grid gap-2 mb-6">
              <Button 
                ...
                className="w-full flex items-center justify-center gap-2 h-11 font-medium text-gray-700 border-gray-300 hover:bg-gray-50"
              >
                {isGoogleLoading ? (
